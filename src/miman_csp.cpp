...
static const unsigned int k_rdp_default_window_size = 3;
static unsigned int g_rdp_ftp_window_size = k_rdp_default_window_size;

unsigned int miman_get_rdp_ftp_window_size(void)
{
    return g_rdp_ftp_window_size;
}

void miman_set_rdp_ftp_window_size(unsigned int window_size)
{
    if (window_size < 1)
        window_size = 1;

    g_rdp_ftp_window_size = window_size;

    printf("[RDP] set g_rdp_ftp_window_size = %u\n", g_rdp_ftp_window_size);
    fflush(stdout);
	console.AddLog("[RDP]##FTP window size changed to %u", g_rdp_ftp_window_size);
}


static const unsigned int k_rdp_default_conn_timeout_ms = 10000;
static const unsigned int k_rdp_default_packet_timeout_ms = 10000;
static const unsigned int k_rdp_default_delayed_acks = 1;
static const unsigned int k_rdp_default_ack_timeout_ms = 8000;
static const unsigned int k_rdp_default_ack_delay_count = 3;

static const unsigned int k_rdp_ftp_conn_timeout_ms = 10000;
static const unsigned int k_rdp_ftp_packet_timeout_ms = 10000;
...
void miman_begin_ftp_rdp_profile(uint32_t ftp_timeout_ms)
{
    ...
    const unsigned int selected_window_size = miman_get_rdp_ftp_window_size();
    ...
    miman_apply_rdp_profile(selected_window_size,
                            ftp_conn_timeout_ms,
                            ftp_packet_timeout_ms,
                            g_saved_rdp_delayed_acks,
                            g_saved_rdp_ack_timeout_ms,
...
void miman_end_ftp_rdp_profile(void)
{
    ...
    printf("[RDP] FTP profile end: keep current RDP profile\n");
    fflush(stdout);
