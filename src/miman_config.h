...
// typedef struct{
// 	char name[30];
// 	char local_path[256] = "file://../data/ftp_downlink/missiondata1010.dat";
// 	char remote_path[256] = "file://./cf/sdcard/mission/mission00001010.dat";
...
typedef struct{
	char name[30];
	char local_path[256] = "file://../data/ftp_downlink/30tilt_mission1007.dat";
	char remote_path[256] = "file://./cf/sdcard/mission/mission00001007.dat";
}__attribute__((packed)) ftpinfo;
...
#define FM_CMD_MID 0x1815;
#define OS_MAX_PATH_LEN 64
#define FM_CREATE_DIRECTORY_CC 12

typedef struct {
    uint8_t CmdHeader[CFE_SB_CMD_HDR_SIZE];
    char    DirectoryName[OS_MAX_PATH_LEN];
} __attribute__((packed)) FM_CreateDirectoryCmd_t;
...
typedef struct {
    ...
    FM_CreateDirectoryCmd_t fmcreatedirectorycmd;
