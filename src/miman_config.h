...
typedef struct{
	char name[30];
	char local_path[256] = "file://./mozart_0106.so";
	// char remote_path[256] = "file://./cf/sdcard/Kiss0_000-479";
    char remote_path[256] = "file://./cf/mozart_0106.so";
...
typedef struct CFE_EVS_LongEventTlm_Payload
{
    ...
    char               Message[122];                                /**< \cfetlmmnemonic \EVS_EVENT
